...
power_system =Model(Gurobi.Optimizer)
set_optimizer_attribute(power_system,"TimeLimit",3600)
...
# this is shhowing error because dict is saving keys as i1.0 bust here it's trying to access using i
